    ...
    <div className="min-h-screen bg-[#050505] text-white pb-32 pt-4 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 max-w-[1800px] mx-auto safe-top select-none w-full">
      ...
      <div className="flex items-center justify-between py-3 mb-4">
        ...
        <div className="flex items-center gap-3">
          <GlassButton
            ...
            icon={copiedLink ? <Check className="w-4 h-4 text-[#E9FF32]" /> : <Share2 className="w-4 h-4" />}
          >
      ...
      <div className="relative rounded-3xl overflow-hidden border border-white/15 h-72 sm:h-96 mb-8 group">
        ...
        <div className="absolute inset-0 p-6 sm:p-10 flex flex-col justify-end">
          <div className="flex flex-wrap items-center gap-2 mb-3">
            <span className="px-3 py-1 rounded-full bg-[#E9FF32]/20 border border-[#E9FF32]/50 text-xs font-mono font-bold text-[#E9FF32]">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <GlassPanel level={1} className="p-4 rounded-2xl border border-white/10 flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-[#E9FF32]/10 border border-[#E9FF32]/30 flex items-center justify-center text-[#E9FF32]">
        ...
        <button
          ...
          className={`px-4 py-2 rounded-xl text-sm font-bold transition-all flex items-center gap-2 ${
            activeSubTab === 'gatherings'
              ? 'bg-[#E9FF32] text-black shadow-lg shadow-[#E9FF32]/20'
        ...
        <div>
          {crewParties.length === 0 ? (
            <GlassPanel level={2} className="p-12 text-center rounded-3xl border border-white/10">
              <PartyPopper className="w-12 h-12 text-[#E9FF32] mx-auto mb-4 opacity-80" />
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="flex items-center gap-4 text-xs text-white/60 mb-3">
                      <span className="flex items-center gap-1">
                        <Calendar className="w-3.5 h-3.5 text-[#E9FF32]" /> {party.date} · {party.time}
                      </span>
                      <span className="flex items-center gap-1">
                        <MapPin className="w-3.5 h-3.5 text-[#E9FF32]" /> {party.location}
                      </span>
                    </div>
                    ...
                    <div className="pt-3 border-t border-white/15 flex items-center justify-between">
                      ...
                      <span className="text-xs font-bold text-[#E9FF32]">
                        Enter Party →
                      </span>
                    </div>
                  </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-5">
            ...
            <GlassButton
              ...
              icon={<Plus className="w-4 h-4 text-[#E9FF32]" />}
            >
              Add Member
            </GlassButton>
          </div>
            ...
            {(crew.members || []).map((m) => (
              <GlassPanel key={m.id} level={1} className="p-4 rounded-2xl border border-white/10 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-1.5">
                      ...
                      {m.role === 'owner' && (
                        <span className="px-1.5 py-0.5 rounded text-[9px] font-mono bg-[#E9FF32]/20 text-[#E9FF32] font-bold">
                          OWNER
                        </span>
                      )}
                      {m.role === 'admin' && (
                ...
                <div className="text-right">
                  ...
                  {m.walletAddress && (
                    <span className="text-[10px] font-mono text-[#E9FF32]/80">{m.walletAddress}</span>
                  )}
                </div>
              </GlassPanel>
            ))}
                ...
                <form onSubmit={handleAddMember} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 rounded-xl bg-white/5 border border-white/15 text-white text-sm outline-none focus:border-[#E9FF32]"
                    />
                  </div>
                  <div>
        ...
        <div>
          <div className="flex items-center justify-between mb-5">
            ...
            <GlassButton
              ...
              icon={<Camera className="w-4 h-4 text-[#E9FF32]" />}
            >
              Add Memory
            </GlassButton>
          </div>
          ...
          {(crew.memories || []).length === 0 ? (
            <GlassPanel level={2} className="p-12 text-center rounded-3xl border border-white/10">
              <Camera className="w-12 h-12 text-[#E9FF32] mx-auto mb-4 opacity-80" />
              ...
              {crew.memories.map((mem) => (
                ...
                >
                  <div className="relative aspect-video overflow-hidden">
                    ...
                    />
                    <div className="absolute top-3 left-3 px-2.5 py-1 rounded-full bg-black/60 backdrop-blur-md text-[10px] font-mono text-[#E9FF32] border border-white/10">
