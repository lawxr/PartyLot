...
export const INITIAL_PARTIES: Party[] = [
  {
    ...
    date: 'Jue 8 sep',
    time: '9:00 PM',
    location: 'Octopus Hotel · Rooftop',
    description: 'Prepárate para una noche de música, baile y momentos inolvidables bajo las luces de la ciudad.',
...
export const INITIAL_CREWS: Crew[] = [
  ...
  },
  {
    id: 'c-hackathon',
    name: 'Hackathon Crew',
    description: 'High-throughput builders, Monad devs, caffeine addicts, and after-party champions.',
