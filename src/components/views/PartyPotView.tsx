...
export const PartyPotView: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white pb-32 select-none">
      ...
      <main className="px-4 sm:px-6 max-w-xl mx-auto pt-2 flex flex-col items-center text-center">
        {/* Title */}
        <span className="text-[11px] font-extrabold uppercase tracking-widest text-[#E9FF32]">
          CREW TREASURY · ERC-4337
        </span>
        <h2 className="font-display font-black text-3xl sm:text-4xl text-white tracking-tight leading-none mt-1 mb-2">
          PARTY POT
        </h2>
        ...
        {/* Social Stake Banner */}
        <div className="w-full p-3.5 rounded-2xl liquid-glass-card mb-6 flex items-center justify-between text-left border border-white/10">
          <div>
            <span className="text-[10px] uppercase font-bold text-[#E9FF32] tracking-wider block">
              SOCIAL PARTICIPATION → ECONOMIC STAKE
            </span>
            <p className="text-xs text-white/80 mt-0.5">
              Leftover pot automatically rolls over to the next gathering.
            </p>
          </div>
          <span className="text-xs font-bold font-mono text-white/60 bg-white/10 px-2 py-1 rounded-lg">
            Tenderly Pro
          </span>
        </div>
        ...
        <div className="w-full text-left">
          <div className="flex items-center justify-between mb-3 px-1">
            ...
            <span className="text-[11px] text-[#E9FF32] font-semibold">Live onchain log</span>
          </div>
