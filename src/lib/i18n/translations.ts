...
export const translations: Record<Language, TranslationDictionary> = {
  es: {
    ...
    joinParty: {
      ...
      codeDescription: 'Ingresa el código de 4 caracteres de tu anfitrión para descifrar tu pase de acceso EIP-712.',
      privateAccessBadge: 'ACCESO PRIVADO · EIP-712',
  ...
  en: {
    ...
    joinParty: {
      ...
      gotACode: 'GOT A CODE?',
      codeDescription: 'Enter the 4-character invite code provided by your host to resolve your encrypted EIP-712 permit.',
      privateAccessBadge: 'PRIVATE ACCESS · EIP-712',
